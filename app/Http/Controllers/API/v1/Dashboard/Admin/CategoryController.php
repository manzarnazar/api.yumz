...
{
    public function __construct(private CategoryService $categoryService,private CategoryRepoInterface $categoryRepository)
    {
        parent::__construct();
    }
    ...
    {
        try {
            Excel::import(new CategoryImport($this->language, $request->input('shop_id')), $request->file('file'));
